...
com.viksaa.sssplash.lib.activity.AwesomeSplash.extend("co.fitcom.SplashScreen", {
    initSplash: function (configSplash) {
       ...
       configSplash.setBackgroundColor(getResource("color","md_amber_300")); //any color you want form colors.xml ("md_blue_900")
        ...
        configSplash.setAnimLogoSplashTechnique(com.daimajia.androidanimations.library.Techniques.Tada); //choose one form Techniques (ref: https://github.com/daimajia/AndroidViewAnimations)
